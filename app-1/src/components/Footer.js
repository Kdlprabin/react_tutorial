                ...
                <div className="social-links">
                    <a href="https://www.instagram.com/herald_bizcore/"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                            height="16" fill="currentColor" className="bi
                            ...
                            <path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088
                                ...
                                1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01
                                3.298-.048c.851-.04 1.434-.174 1.943-.372a3.916
                                3.916 0 0 0
                                ...
                                10.172 0 7.998 0h.003zm-.717 1.442h.718c2.136 0
                                2.389.007 3.232.046.78.035 1.204.166
                                ...
                                1.92.96.96 0 0 0 0-1.92zm-4.27 1.122a4.109 4.109
                                0 1 0 0 8.217 4.109 4.109 0 0 0 0-8.217zm0
                                1.441a2.667 2.667 0 1 1 0 5.334 2.667 2.667 0 0 
                                1 0-5.334z"/>
                            </svg>
                        </a>
                        <a
                            href="https://www.facebook.com/groups/857865105165454/"
                            className="nodecor">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" fill="currentColor" className="bi
                            ...
                            <a href="https://www.tiktok.com/@herald_bizcore"
                                className="nodecor">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="16" fill="currentColor"
                                    className="bi bi-tiktok" viewBox="0 0 16 16">
                                    <path d="M9 0h1.98c.144.715.54 1.617 1.235
                                        2.512C12.895 3.389 13.797 4 15
                                        4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0
                                        1 1-5-5v2a3 3 0 1 0 3 3V0Z"/>
                                    </svg>
                                </a>
                                <a
                                    href="https://np.linkedin.com/in/herald-bizcore-bb8776214"
                                    className="nodecor">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        width="16" height="16"
                                        fill="currentColor" className="bi
                            ...
                            <p className="text-center">&copy;Herald Bizcore Community
                                2022. By Prabin Kandel</p>
                        </footer>
  )
}
